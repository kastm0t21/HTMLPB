                        ...
                        <div class="row products">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.php">Party Bargains Premium Heavyweight Hard Plastic 4 Sectional Rectangular Serving
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.php">Party Bargains 6 Sectional Round Plastic Serving Tray, Size: 12 inch, Color:
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.php">Party Bargains Plastic Rectangle Serving Tray | Elegant Silver Edged Flower Rim
                                                - Large | Pack of 4</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.php">Party Bargains Plastic Oval Trays | Durable Hard Plastic Elegant Ivory Food Serving
