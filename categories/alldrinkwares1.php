 ...
 _________________________________________________________ -->
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row products">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Premium Quality Plastic Disposable 5 oz Cups 100 Count (2 PACK)</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Premium Quality Plastic Disposable 7 oz cups (400 PACK)</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">7 Oz. Plastic Clear/Transparent Cups (100 Count)</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains 9 oz Clear Plastic Disposable Cups (CASE OF 960)</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Blue Sky 80 Count Plastic Cups, 9 oz., Clear</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Mini Red Disposable Shot Glasses | Plastic Shot Cups, Jello Shots,
                                                Jager Bomb, Beer Pong, Perfect Size for Serving Condiments, Snacks, Samples
                                                and Tastings - 2oz | Pack of 120.</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Red Plastic Party Cup Cold Cups 16 Ounce 100 Pack</a>
                                        </h5>
                                        <p class="price">$9.49
                                            <del>$15.99</del>
                                        </p>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Simcha Collection Wine Glasses | Elegant design, Crystal-like Hard Unbreakable
                                                Disposable Plastic - Size 8 Oz | Pack of 4</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Plastic Wine Glasses | Elegant Hard Plastic Disposable Wine Glass
                                                Ideal for Parties and Wedding to Serve Champagne & Wine | Pack of 8</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Elegant Tall Square Mini Cube 3oz Clear Plastic Dessert Cups,
                                                Set Of 40 Tall Dessert Cups And Shot Glass, Parfait, Souffle Jello Glasses,
                                                Shooter Glasses
                                            </a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Crystal Clear Hard Plastic 7oz Round Party Tumblers/Cups 20 count
                                                (4 PACK)</a>
                                        </h5>
                                        <p class="price">
                                            $14.99</p>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Shot Cups | Disposable Hard Plastic Shooter Glasses - 2 oz | Pack
                                                of 200</a>
                                        </h5>
                                        <p class="price">$15.99</p>
                                        <p class="buttons">
                        ...
                        <div class="pages">
                            ...
                            <ul class="pagination">
                                <li class="active">
                                    <a href="alldrinkware1.html">1</a>
                                </li>
                                <li>
                                    <a href="alldrinkwares2.html">2</a>
                                </li>
                                <li>
                                    <a href="alldrinkwares2.html">&raquo;</a>
                                </li>
                            </ul>
                        </div>
                    </div>
