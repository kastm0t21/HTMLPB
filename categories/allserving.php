...
<body>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="col-md-9">
                        <div class="box">
                            <h1>All Serving Trays & Utensils</h1>
                        </div>
                        ...
                        <div class="row products">
                            ...
                            <div class="col-md-4 col-sm-6" id="productimg">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">White Plastic Serving Tray, Rectangular 18" x 12" Pack Of 4</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Plastic Rectangle Serving Tray | Elegant Silver Edged Flower Rim
                                                - Large | Pack of 4</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Premium Heavyweight Hard Plastic 4 Sectional Rectangular Serving
                                                Tray, 5 x 16 Inches, 4 Pack (WHITE)</a>
                                        </h5>
                                        <p class="price">
                                            $13.49</p>
                                        <p class="buttons">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains 6 Sectional Round Plastic Serving Tray, Size: 12 inch, Color:
                                                White/Silver, Pack of 4</a>
                                        </h5>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Plastic Oval Trays | Durable Hard Plastic Elegant Ivory Food Serving
                                                Tray Ideal for Catering, Food Service & Appetizers - 17" | Pack of 6</a>
                                        </h5>
                                        <p class="price">$12.99</p>
                                        <p class="buttons">
                                            <a href="basket.html" class="btn btn-primary">View Details</a>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="product">
                                    ...
                                    <div class="text">
                                        <h5>
                                            <a href="detail.html">Party Bargains Plastic Serving Tongs, Color: Clear, Size: 8.5Inch, Count: Pack
                                                of 12
                                            </a>
                                        </h5>
