 ...
 _________________________________________________________ -->
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row" id="productMain">
                            ...
                            <div class="col-sm-6">
                                <div class="box">
                                    <h2 class="text-center">Clear 5 oz. Plastic Bowls - 40 Count</h2>
                                ...
                                <div class="row" id="thumbs">
                                    <div class="col-xs-4">
                                        <a href="../img/products/bowls/Clear 5 oz. Plastic Bowls - 40 Count/71aiD2lU59L._SL1500_.jpg" class="thumb">
                                            <img src="../img/products/bowls/Clear 5 oz. Plastic Bowls - 40 Count/71aiD2lU59L._SL1500_.jpg" alt="" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="../img/products/bowls/Clear 5 oz. Plastic Bowls - 40 Count/21P1jaTon8L.jpg" class="thumb">
                        ...
                        <div class="box" id="details">
                            <p>
                                ...
                                <p>Clear dinner bowls are affordable, practical and classy. The clear plastic dazzles your party
                                    decor, without subtracting from the color scheme. Clearly designed for you, these bowls
                                    can hold the small or big servings of soups, desserts or such. Check out all available
                                    sizes to meets your specific need. Blue sky Inc. Is a leading company in the party-goods
                                    field and knows your needs, precisely!.</p>
                                <h4>Size</h4>
                                <ul>
                                    <li>5oz</li>
                                </ul>
